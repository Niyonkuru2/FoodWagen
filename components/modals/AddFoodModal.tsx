    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-100/50 z-50 animate-slide-up">
      <div className="bg-white rounded-2xl shadow-lg w-[90%] max-w-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-gray-700 text-sm">
          <InputField id="food_name" name="food_name" placeholder="Food Name" value={form.food_name ?? ""} onChange={handleChange} error={errors.food_name} />
          <InputField id="food_rating" name="food_rating" type="number"  placeholder="Food Rating" value={form.food_rating ?? ""} onChange={handleChange} error={errors.food_rating} />
          <InputField id="food_image" name="food_image"  placeholder="Food Image (link)" value={form.food_image ?? ""} onChange={handleChange} error={errors.food_image} />
          <InputField id="price" name="price"  placeholder="Price" value={form.price ?? ""} onChange={handleChange} error={errors.price} />
          <InputField id="restaurant_name" name="restaurant_name"placeholder="Restaurant Name" value={form.restaurant_name ?? ""} onChange={handleChange} error={errors.restaurant_name} />
          <InputField id="restaurant_logo" name="restaurant_logo" placeholder="Restaurant Logo (link)" value={form.restaurant_logo ?? ""} onChange={handleChange} error={errors.restaurant_logo} />
